            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre_cientifico" name="especie_cientifico" required>
                        <div class="invalid-feedback"></div>
                    </div>
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    const btnEdit = `<button class="btn btn-primary btn-sm btn-edit" title="Editar" data-id="${row.especie_id}">
                        <i class="bi bi-pencil-square"></i>
                    </button>`;

                    const btnToggleEstado = `<button class="btn btn-sm ${row.especie_estado ? 'btn-danger' : 'btn-success'} btn-toggle-estado" title="${row.especie_estado ? 'Desactivar' : 'Activar'}" data-id="${row.especie_id}">
                        ${row.especie_estado ? '<i class="bi bi-x-circle"></i>' : '<i class="bi bi-check-circle"></i>'}
                    </button>`;
