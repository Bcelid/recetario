            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="subespecie_nombre" name="subespecie_nombre" required>
                        <div class="invalid-feedback"></div>
                    </div>

                    <div class="mb-3">
                        <label for="subespecie_cientifico" class="form-label">Nombre Científico *</label>
                        <input type="text" class="form-control" id="subespecie_cientifico" name="subespecie_cientifico" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    return `
                        <div class="d-flex gap-1">
                            ...
                            <button class="btn btn-sm ${data.subespecie_estado == 1 ? 'btn-danger' : 'btn-success'} btn-toggle-estado" data-id="${data.subespecie_id}">
                                ${data.subespecie_estado == 1 ? '<i class="bi bi-x-circle"></i>' : '<i class="bi bi-check-circle"></i>'}
                            </button>
                        </div>`;
                }
            }
