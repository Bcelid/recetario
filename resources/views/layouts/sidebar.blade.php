            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('reports.prescriptions.index') }}"
                                class="nav-link text-white ps-4 {{ request()->routeIs('reports.prescriptions.*') ? 'active' : '' }}"
                                @if (request()->routeIs('reports.prescriptions.*')) style="background-color: #198754;" @endif>
