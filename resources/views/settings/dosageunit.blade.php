                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="unidad_representacion"
                                name="unidad_medida_dosificacion_representacion" required>
                            <div class="invalid-feedback"></div>
                        </div>

                        <div class="mb-3">
                            <label for="unidad_detalle" class="form-label">Detalle</label>
                            <input type="text" class="form-control" id="unidad_detalle"
                                name="unidad_medida_dosificacion_detalle">
                            <div class="invalid-feedback"></div>
                        </div>
