...
@section('content')
    ...
    <div class="modal fade" id="propietarioModal" tabindex="-1" aria-labelledby="propietarioModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <form id="propietarioForm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre_propietario"
                                name="propietario_almacen_nombre" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="apellido_propietario"
                                name="propietario_almacen_apellido" required>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="direccion_propietario"
                                name="propietario_almacen_direccion" required>
                            <div class="invalid-feedback"></div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="btnSavePropietario">
                            Guardar
                        </button>
